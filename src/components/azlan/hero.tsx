...
export function Hero({ settings }: { settings: Settings | null }) {
  ...
  return (
    <section className="relative overflow-hidden bg-[#072413] text-white flex items-center pt-28 sm:pt-36 lg:pt-12 pb-16 lg:pb-20">
      ...
      <div className="absolute top-1/4 right-0 w-[600px] h-[600px] rounded-full bg-[#003816] opacity-40 blur-[100px] pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 sm:space-y-8 text-left z-10 pt-4 lg:pt-0">
            ...
            <div className="inline-flex items-center">
              <div
                className={`inline-flex items-center gap-2.5 px-4 py-2 rounded-full text-xs sm:text-sm font-extrabold backdrop-blur-md border shadow-md transition-all ${isOpen
              ...
              >
                <span className="relative flex h-2.5 w-2.5 shrink-0">
                  <span
                    className={`absolute inline-flex h-full w-full rounded-full opacity-75 ${isOpen ? "bg-emerald-400 animate-ping" : "bg-rose-400"
                      }`}
                  />
                  <span
                    className={`relative inline-flex h-2.5 w-2.5 rounded-full ${isOpen ? "bg-emerald-400" : "bg-rose-500"
                      }`}
                  />
                </span>
            ...
            <div className="pt-1">
              <a
                href="/#menu"
                className="inline-flex items-center gap-2.5 px-8 py-4 rounded-full font-black text-sm sm:text-base bg-[#FFC700] text-[#072413] hover:bg-[#ffe066] hover:scale-105 active:scale-95 transition-all shadow-[0_10px_30px_rgba(255,199,0,0.3)] group"
              >
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0 flex items-center justify-center lg:justify-end">
            <div className="relative w-full max-w-[540px] h-[360px] sm:h-[460px] lg:h-[500px]">
              ...
              {/* Slanted Card 1 (Main Zinger Burger) */}
              <div
                className="absolute left-0 top-0 w-[62%] h-[92%] z-20 rounded-3xl overflow-hidden shadow-2xl border-2 border-[#FFC700]/70 group transition-all duration-500 hover:scale-[1.03] hover:z-30 hover:border-[#FFC700]"
                style={{
              ...
              <div
                className="absolute right-0 bottom-0 w-[60%] h-[92%] z-10 rounded-3xl overflow-hidden shadow-2xl border-2 border-[#5BE193]/60 group transition-all duration-500 hover:scale-[1.03] hover:z-30 hover:border-[#5BE193]"
                style={{
              ...
              <div className="absolute left-[20%] bottom-0 z-20 w-24 h-24 sm:w-28 sm:h-28 rounded-2xl overflow-hidden shadow-xl border border-white/20 hidden sm:block transform -rotate-12 hover:rotate-0 transition-transform duration-300">
                <Image
              ...
              <div className="absolute inset-0 z-0 bg-gradient-to-r from-[#FFC700]/20 to-[#5BE193]/20 blur-2xl rounded-full transform scale-90 pointer-events-none" />
